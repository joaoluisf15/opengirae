...
export default class SetImgSinglesCommand extends Command {
  static override info = {
    guards: ['isAdmin'],
    name: 'setimgsingles',
    description: 'Define a imagem de banner da variante de singles de um gênero (staff)',
    usage: '/setimgsingles <ID ou nome do gênero>',
  }

  @CommandArgument([{ name: 'subcategory', type: CommandArgumentType.DISCOTECA_SUBCATEGORY, subcategoryType: 'single', description: 'ID ou nome da subcategoria de singles' }])
